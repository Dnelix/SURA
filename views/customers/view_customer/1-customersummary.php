                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    <div class="d-flex flex-column">
                        <div class="d-flex align-items-center mb-1">
                            <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3"><?= $customerName ?></a>
                ...
                <div class="d-flex flex-wrap justify-content-start">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                            ...
                            <div class="fw-bold fs-6 text-gray-400">Open <?= $alt_job; ?>s</div>
                        </div>
                        ...
                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="fs-4 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$"><?= $defaultcurrency; ?>15,000</div>
                            </div>
                            <div class="fw-bold fs-6 text-gray-400">Amount Earned</div>
                        </div>
                    </div>
