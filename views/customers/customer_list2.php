    <div class="card card-xl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-bold fs-7">You have registered 37 customers</span>
            </h3>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text-muted fw-bold text-muted d-block fs-7">annasmitherin@gmail.com</span>
                            </td>
                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">081239492489</a>
