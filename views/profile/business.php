<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_business_details" class="collapse show">
        <form id="kt_account_business_details_form" class="form">
            <div class="card-body border-top p-9">
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/brand-logos/vodafone.svg')">
                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url(assets/media/avatars/300-27.jpg)"></div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="bizname" class="form-control form-control-lg form-control-solid" placeholder="Company/Business name" value="" />
                    </div>
                </div>
                <div class="row mb-6">
                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Description</label>
                    <div class="col-lg-8 fv-row">
                        <textarea class="form-control form-control-solid" rows="4" name="description" placeholder="Tell us a little about what you do"></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Contact phone number" value="<?= $userdata->phone; ?>" />
                    </div>
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="email" class="form-control form-control-lg form-control-solid" placeholder="Business email" value="<?= $userdata->email; ?>" />
                    </div>
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="website" class="form-control form-control-lg form-control-solid" placeholder="www.zzz.com" value="" />
                    </div>
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-lg-4 fv-row">
                                <select name="state" aria-label="Select a state/province" data-control="select2" data-placeholder="Select a state/province..." class="form-select form-select-solid form-select-lg fw-bold">
                            ...
                            <div class="col-lg-4 fv-row">
                                <select name="state" aria-label="Select LGA" data-control="select2" data-placeholder="Select LGA..." class="form-select form-select-solid form-select-lg fw-bold">
                ...
                <div class="row mb-6">
                    <label class="col-lg-4 col-form-label fw-bold fs-6">Office/Business Address</label>
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="address" class="form-control form-control-lg form-control-solid" placeholder="Block B, 121 Ikate" value="" />
                    </div>
                </div>
