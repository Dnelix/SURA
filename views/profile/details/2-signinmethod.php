        ...
        <div class="card-body border-top p-9">
                    ...
                    <form id="kt_signin_change_username" class="form" novalidate="novalidate">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="fv-row mb-0">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" id="username" placeholder="Username" name="username" value="<?= $userdata->username; ?>" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="fv-row mb-0">
                        ...
                        <div class="d-flex">
                            <button id="kt_uname_submit" type="button" class="btn btn-primary me-2 px-6">
                                <?= displayLoadingIcon('Update Username'); ?>
                            </button>
            ...
            <div class="d-flex flex-wrap align-items-center">
                <div id="kt_signin_email">
                    ...
                    <div class="fw-bold text-gray-600"><?= $userdata->email; ?></div>
                </div>
                    ...
                    <form id="kt_signin_change_email" class="form" novalidate="novalidate">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="fv-row mb-0">
                                    ...
                                    <input type="email" class="form-control form-control-lg form-control-solid" id="emailaddress" placeholder="Email Address" name="emailaddress" value="<?= $userdata->email; ?>" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="fv-row mb-0">
                        ...
                        <div class="d-flex">
                            <button id="kt_signin_submit" type="button" class="btn btn-primary me-2 px-6">
                                <?= displayLoadingIcon('Update Email'); ?>
                            </button>
                    ...
                    <form id="kt_signin_change_password" class="form" novalidate="novalidate">
                        ...
                        <div class="d-flex">
                            <button id="kt_password_submit" type="button" class="btn btn-primary me-2 px-6">
                                <?= displayLoadingIcon('Update Password'); ?>
                            </button>
