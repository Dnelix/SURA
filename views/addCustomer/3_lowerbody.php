    <div class="" data-kt-stepper-element="content">
        <div class="w-100">
            <div class="pb-10 pb-lg-15">
                <h2 class="fw-bolder d-flex align-items-center text-dark">Lower Body Measurements 
                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Your lower body measurements. These measurements cover for trousers, skirts, shorts, etc. The results are usually better when someone else takes the measurements."></i></h2>
