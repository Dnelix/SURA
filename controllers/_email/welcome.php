...
<body style="font-family: 'Inter', sans-serif; background: #E5E5E5;">
  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="{$color_sec}">
    <tbody>
      <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Click the button below to complete your account activation and login:
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Use any of the options below if you need some help to get started:
                        </td>
                      </tr>
                      <tr>
