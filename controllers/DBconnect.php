    ...
    class DBconnect {
        ...
        public static function connectWriteDB() {
            if(self::$writeDBConnection === null) { //if connection have not already been initiated
                self::$writeDBConnection = new PDO('mysql: host=localhost; dbname=sura; charset=utf8', 'root', 'root'); //using PDO to connect to mysql db
        ...
        public static function connectReadDB() {
            if(self::$readDBConnection === null) { //if connection have not already been initiated
                self::$readDBConnection = new PDO('mysql: host=localhost; dbname=sura; charset=utf8', 'root', 'root');
